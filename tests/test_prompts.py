...
from concord.llm.prompts import (
    get_prompt_template, build_annotation_prompt, choose_bucket,
    list_available_templates, save_template, _validate_template,
    LABEL_SET, BucketPrompt
)
...
class TestPrompts(unittest.TestCase):
    ...
    @mock.patch('concord.llm.prompts._TEMPLATES', {'v1.0': 'Template 1', 'v1.1-test': 'Template 2'})
