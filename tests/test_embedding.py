...
from concord.embedding import (
    embed_sentence, batch_embed, cosine_sim, 
    similarity, preload_model, clear_cache
)
...
class TestEmbedding(unittest.TestCase):
    ...
    def test_embed_sentence(self):
        ...
        self.assertEqual(embedding.size(0), 768)  # PubMedBERT embeddings are 768-dimensional
